{"inherits": "pesterchum2.5",
 ...
 {"background-image": "$path/tnbg.png",
  ...
  "windowtitle": "TALKR",
  "menu" : { "style": "font-family: 'Courier'; font: bold; font-size: 14px; background-color: #a82f38;border:2px solid #a25f63", "loc": [3, 6] },
  ...
  "defaultwindow": { "style": "background: #a82f38; font-family:'Courier';font:bold;selection-background-color:#a25f63; " },
  "chums": { "style": "border:2px solid #ffa4a4; background-color: black;color: white;font: bold;font-size:14px;font-family: 'Courier';selection-background-color:#646464; ",
             "moods": { 
  ...
  "mychumhandle": { "label": 
					...
					"handle": { "style": "background-color: black; padding: 3px; padding-left: 25px; color:white; font-family:'Courier'; font:bold; text-align:left; border:2px solid #ffa4a4;" }
                  },
  "addchum":  { "text": "ADD FRIEND", "style": "background: #ffa4a4; border:2px solid #780000; font: bold; color: black; font-family:'Courier';"
              },
  "pester": { "text": "BUG", "style": "background: #ffa4a4; border:2px solid #780000; font: bold; color: black; font-family:'Courier';"
            },
  "block": { "style": "background: #ffa4a4; border:2px solid #780000; font: bold; color: black; font-family:'Courier';"
           },
  "moodlabel": { "style": "font:bold;font-family:'Courier';color:black;"
			   },
  "defaultmood": 7,
  "moods": [
      { "style": "text-align:left; background:#ffa4a4;border:2px solid #780000;color: black; font-family:'Courier'; font:bold; padding-left:3px;", 
		"selected": "text-align:left; background:white; border:2px solid #780000; color: black; font-family:'Courier'; font:bold; padding-left:3px;",
		"loc": [15, 485],
		"size": [135, 30],
	    "text": "ECSTATIC",
      ...
      { "style": "text-align:center; border:2px solid #780000; background:black;color: white; font-family:'Courier'; font:bold;padding-left:3px;", 
		"selected": "text-align:left; background:white; border:2px solid #780000; padding: 5px;color: black; font-family:'Courier'; font:bold;padding-left:3px;",
		"loc": [15, 569],
		"size": [268, 30],
		"text": "ABSCOND",
 ...
 "convo": {
	 ...
	 "textarea": {
		 "style": "background: white;  font-size: 14px;font:bold; border:2px solid #ffa4a4;text-align:center; margin-right:10px; margin-left:10px;font-family: 'Courier'"
 	 },
  ...
  "text": {
      "beganpester": "began bugging",
      "ceasepester": "stopped bugging",
      "blocked": "blocked",
 ...
 { "size": [600,425],
   ...
   "input": { "style": "background: white; border:2px solid #ffa4a4;margin-top:5px; margin-right:10px; margin-left:10px; font-size: 12px;" },
   "time": { "text": { "style": " border: 2px solid #780000; background: white; font-size: 12px; margin-top: 5px; margin-right: 5px; margin-left: 5px; font-family:'Courier';font:bold;" 
                    },
